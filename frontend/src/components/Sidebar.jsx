...
export default function Sidebar({ open, onClose }) {
  return (
    <>
      ...
      <aside
        className={`fixed z-40 inset-y-0 left-0 w-60 lg:w-64 bg-ink-950 text-mist-200 flex flex-col h-full shrink-0 transition-transform duration-200 lg:translate-x-0 lg:static lg:z-auto ${open ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
