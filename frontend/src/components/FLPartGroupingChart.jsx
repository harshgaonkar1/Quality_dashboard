...
function FLPartGroupingChart({ partGroups = [], flTotal = 0, activeDate = '', isCompact = false }) {
  ...
  }), [categories, isAdmin, lineColor, gridColor, textColor, subTextColor, tooltipBg, tooltipBorder, flTotal, stackedSeries]);
  ...
  return (
    <div className="panel p-2 lg:p-2.5 flex flex-col h-full w-full min-h-0 border-t-4 border-t-sky-500 shadow-panel relative">
      ...
      <div ref={containerRef} className="flex-1 min-h-0 w-full relative">
        {isZero ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-4 bg-mist-50/60 dark:bg-ink-950/40 rounded-xl border border-dashed border-sky-300 dark:border-sky-900/60">
